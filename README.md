...
This code is formatted specifically for a GitHub README, with badges, emojis, and sectioning that should carry over directly when pasted into a markdown file on GitHub.
여기부분도 위에처럼 코드로 줘
